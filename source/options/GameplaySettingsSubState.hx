...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Smooth Health',
			'If Check, makes the health bar \'smooth\' instead of snapping instantly.',
			'allowSmoothHealth',
			BOOL);
		addOption(option);

		var option:Option = new Option('V-slice',
			'If Check, Makes it like most of Vslice hud and scoring system. (WIP)',
			'allowVslice',
			BOOL);
		addOption(option);
